    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnAddProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbRef = FirebaseDatabase.getInstance().getReference("Doctor").child(id);

                boolean flag = false;

                String fullName = binding.etPatientName.getText().toString();
                if (!fullName.equals("")) {
                    dbRef.child("fname").setValue(fullName);
                    flag = true;
                }
